...
<body class="bg-gradient-to-r from-cyan-200 to-purple-400">
    ...
    <section class="pt-20 lg:pt-[120px] pb-10 lg:pb-20  mt-5 mx-64">
        <div class="container">
            <div class="flex flex-wrap -mx-4">
                <div class="w-full lg:w-1/2 xl:w-2/4 px-4 mb-10">
                    <!--  <div class="grid grid-cols-6 gap-4 my-20 ">
                        <div class="col-start-2 col-end-4 text-center ">-->
                    <div class="home__greetings mb-4">
                        <p class="grid justify-center">Hello I'm</p>
                    </div>
                    ...
                    <div class="grid grid-cols-2 ">
                        <button data-tooltip-target="tooltip-bottom" data-tooltip-placement="bottom" class="E-mail"
                            onclick="copyFunction()" id="btnE">
                            adrienthomas54@gmail.com
                        </button>
                    ...
                    <div class="grid justify-items-end">
                        <div id="divCacher" class="hidden ">
                            <div class="home__bluetings mt-3">
                                <p class="px-1 m-0">E-mail copier !!</p>
                            </div>
                        </div>
                    </div>
                    <!-- </div>
                ...
                <div class="w-full lg:w-1/2 xl:w-2/4 px-4">
    ...
    <section class="pt-20 lg:pt-[120px] pb-10 lg:pb-20  mt-5 mx-64">
        <div class="container">
            <div class="flex flex-wrap -mx-4">
                <div class="w-full lg:w-1/2 xl:w-3/12 px-4 mb-10">
                ...
                <div class="w-full lg:w-1/2 xl:w-9/12 px-4 mb-10">


                    <div class="col-start-3 col-end-6 text-center">
                        <h1 class="text-left ml-10 mb-5 text-3xl font-medium text-gray-600" id="about">À propos de moi
                        </h1>
                        <p class="text-left text-gray-700 text-lg"> Bonjour, je m'appelle Adrien, développeur
                            back/front-end basé en
                            français.
    ...
    <section class="pt-20 lg:pt-[120px] pb-10 lg:pb-20 m-24 mt-5">
        <div class="container">
            <div class="flex flex-wrap -mx-4">
                    ...
                    <div class="bg-white rounded-lg overflow-hidden mb-10 shadow-2xl">
                        ...
                        <div class="p-8 sm:p-9 md:p-7 xl:p-9 text-center">
                            ...
                            <p class="text-justify text-body-color leading-relaxed mb-7">
                                J'ai essaiyer de reproduire un site similaire a instagram dans la forme.
                                Mais avec un
                                nombre de
                                fonctionnalités restreintes, connexion et création du compte(si pseudo
                                non existant),
                                barre de recherche, publication de poste et un profil personnalisable
                            </p>
                            <a href="javascript:void(0)"
                                class="inline-block py-2 px-7 border border-[#E5E7EB] rounded-full text-base text-body-color font-medium hover:border-primary hover:bg-black hover:text-white transition">
                                Voir plus
                            </a>
                        </div>
                    </div>
                ...
                <div class="w-full md:w-1/2 xl:w-1/3 px-4">
                    <div class="bg-white rounded-lg overflow-hidden mb-10 shadow-2xl">
                        <img src="./data/drumpad.png" alt="image" class="w-full" />
                        <div class="p-8 sm:p-9 md:p-7 xl:p-9 text-center">
                            <h3>
                                <a href="javascript:void(0)"
                                    class="font-semibold text-dark text-xl sm:text-[22px] md:text-xl lg:text-[22px] xl:text-xl 2xl:text-[22px] mb-4 block hover:text-primary">
                            ...
                            <p class="text-justify text-body-color leading-relaxed mb-7">
                                Création d'un drumpad pour débuter mon apprentissage en JS. A l'aide
                                d'écouteurs
                                d'événements liés à des boutons ou à des touches du clavier, ainsi que
                                l'intégration
